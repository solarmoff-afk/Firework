...
fn check_type_mutable(type_name: &str, method: &str) -> bool {
    ...
    match base_type {
        ...
        // Option
        "Option" => {
            let mutable_methods = ["take", "replace"];
        ...
        "Cell" => {
            let mutable_methods = ["set", "swap", "replace", "take", "into_inner", "get_mut"];
        ...
        "Mutex" => {
            let mutable_methods = ["lock", "get_mut", "into_inner"];

            mutable_methods.contains(&method)
        }

        "RwLock" => {
            let mutable_methods = ["write", "get_mut", "into_inner"];
            mutable_methods.contains(&method)
        }
